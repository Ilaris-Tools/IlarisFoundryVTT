...
> **Canonical instructions:** Read root [`AGENTS.md`](../../../AGENTS.md), then read the **Explore (`openspec-explore`)** section of [`OPENSPEC_OPERATIONS.md`](../../../.agents/OPENSPEC_OPERATIONS.md) in full. That shared section is the only active operation body; the legacy provider copy below MUST NOT override it.
