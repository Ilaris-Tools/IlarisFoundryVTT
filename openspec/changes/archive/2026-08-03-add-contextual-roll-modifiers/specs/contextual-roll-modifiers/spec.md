...
FertigkeitDialog. It SHALL offer no special situation, social duel, waiting in
a social duel, investigation/research, and destroying/breaking an object. A
caller-supplied known situation SHALL initialize the selection.
...
[`Actor.allApplicableEffects()`](https://foundryvtt.com/api/v14/classes/foundry.documents.Actor.html)
and SHALL not participate in supernatural strongest-effect selection.
