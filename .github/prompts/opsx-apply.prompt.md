...
> **Repository policy:** Read root [`AGENTS.md`](../../AGENTS.md) before using this command. The canonical policy requires OpenSpec for significant work and a non-`BLOCK` `## Proposal Self-Review` before application.
