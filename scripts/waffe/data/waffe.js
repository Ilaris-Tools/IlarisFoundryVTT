import { CombatItem } from '../../items/data/combat-item.js'
import { EigenschaftCache } from '../properties/utils/eigenschaft-cache.js'
import { ProcessorFactory } from '../properties/processors/processor-factory.js'
...
export class WaffeItem extends CombatItem {
    ...
    _calculateWeaponStats() {
        ...
        system.manoever.rllm = { selected: game.settings.get('core', 'messageMode') }
