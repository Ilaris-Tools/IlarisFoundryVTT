export function magieUpdate(html, actor, item) {
    ...
    if (html.find('#mm_mama').length > 0) {
        ...
        item.data.data.manoever.mm_mama.selected = checked;
    ...
    if (html.find('#mm_rwrh').length > 0) {
        ...
        item.data.data.manoever.mm_rwrh.selected = checked;
    ...
    if (html.find('#mm_vbvk').length > 0) {
        ...
        item.data.data.manoever.mm_vbvk.selected = checked;
    ...
    if (html.find('#mm_wkvl').length > 0) {
        ...
        item.data.data.manoever.mm_wkvl.selected = checked;
    ...
    if (html.find('#mm_ztig').length > 0) {
        ...
        item.data.data.manoever.mm_ztig.selected = checked;
    ...
    if (html.find('#mm_kosp').length > 0) {
        ...
        item.data.data.manoever.mm_kosp.selected = checked;
