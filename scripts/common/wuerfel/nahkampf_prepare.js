/*
  ...
  item.data.data.manoever.km_ever.selected = checked;
...
export function nahkampfUpdate(html, actor, item) {
    ...
    */
    ...
    item.data.data.manoever.vlof.selected = checked;
    ...
    if (html.find('#km_entw_at').length > 0) {
        ...
        item.data.data.manoever.km_entw.selected_at = checked;
    ...
    if (html.find('#km_entw_vt').length > 0) {
        ...
        item.data.data.manoever.km_entw.selected_vt = checked;
    ...
    if (html.find('#km_gzsl').length > 0) {
        ...
        item.data.data.manoever.km_gzsl.selected = checked;
    ...
    if (html.find('#km_rust').length > 0) {
        ...
        item.data.data.manoever.km_rust.selected = checked;
    ...
    if (html.find('#km_shsp').length > 0) {
        ...
        item.data.data.manoever.km_shsp.selected = checked;
    ...
    if (html.find('#km_stsl').length > 0) {
        ...
        item.data.data.manoever.km_stsl.selected = checked;
    ...
    if (html.find('#km_befr').length > 0) {
        ...
        item.data.data.manoever.km_befr.selected = checked;
    ...
    if (html.find('#km_dppl').length > 0) {
        ...
        item.data.data.manoever.km_dppl.selected = checked;
    ...
    if (html.find('#km_hmsl').length > 0) {
        ...
        item.data.data.manoever.km_hmsl.selected = checked;
    ...
    if (html.find('#km_kltz').length > 0) {
        ...
        item.data.data.manoever.km_kltz.selected = checked;
    ...
    if (html.find('#km_ndwf').length > 0) {
        ...
        item.data.data.manoever.km_ndwf.selected = checked;
    ...
    if (html.find('#km_rpst').length > 0) {
        ...
        item.data.data.manoever.km_rpst.selected = checked;
    ...
    if (html.find('#km_shwl').length > 0) {
        ...
        item.data.data.manoever.km_shwl.selected = checked;
