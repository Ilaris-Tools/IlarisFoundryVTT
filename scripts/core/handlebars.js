...
function preloadHandlebarsTemplates() {
    const templatePaths = [
        'systems/Ilaris/scripts/actors/templates/held/tabs/attribute.hbs',
        'systems/Ilaris/scripts/actors/templates/held/tabs/fertigkeiten.hbs',
        ...
        'systems/Ilaris/scripts/actors/templates/held/tabs/inventory/finances.hbs',
        'systems/Ilaris/scripts/actors/templates/held/tabs/inventory/handcart.hbs',
        'systems/Ilaris/scripts/actors/templates/held/tabs/inventory/supporting.hbs',

        'systems/Ilaris/scripts/items/templates/base_item_layout.hbs',

        'systems/Ilaris/scripts/core/templates/helpers/select_attribut.hbs',
        'systems/Ilaris/scripts/core/templates/helpers/select_fertigkeitsgruppe.hbs',
        ...
        'systems/Ilaris/scripts/effects/templates/supernatural-pre-effects-section.hbs',
        'systems/Ilaris/scripts/effects/templates/supernatural-pre-effect-config.hbs',
