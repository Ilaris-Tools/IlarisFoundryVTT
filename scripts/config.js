...
let label = {
    ...
    // magiemanöver
    mm_mama: 'Mächtige Magie (Zauber -4)',
    mm_mezi: 'Mehrere Ziele (ZAuber -4)',
    mm_rwrh: 'Reichweite erhöhen (Zauber -4)',
    mm_vbvk: 'Vorbereitung verkürzen (Zauber -4)',
    mm_wkvl: 'Wirkungsdauer verlängern (Zauber -4)',
    mm_ztig: 'Zaubertechnik ignorieren (Zauber -4)',
    mm_erzw: 'Erzwingen (Zauber +4)',
    mm_kosp: 'Kosten sparen (Zauber -4)',
    mm_ztls: 'Zeit lassen (Zauber +2)',
    mm_zere: 'Zeremonie (Zauber +X)',
    mm_opfe: 'Opferung (Zauber +4)',
    // karmamanöver
    lm_mali: 'Mächtige Liturgie (Liturgie -4)',
    lm_mezi: 'Mehrere Ziele (Liturgie -4)',
    lm_ltig: 'Liturgische Technik ignorieren (Liturgie -4)',
    lm_rwrh: 'Reichweite erhöhen (Liturgie -4)',
    lm_vbvk: 'Vorbereitung verkürzen (Liturgie -4)',
    lm_wkvl: 'Wirkungsdauer verlängern (Liturgie -4)',
    lm_kosp: 'Kosten sparen (Liturgie -4)',
    lm_zere: 'Zeremonie (Liturgie +X)',
    lm_opfe: 'Opferung (Liturgie -4)',
    // sonstige
    gewicht: 'Platzbedarf',
};
ILARIS.label = label;
