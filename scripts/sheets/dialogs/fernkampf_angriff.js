...
export class FernkampfAngriffDialog extends CombatDialog {
    ...
    async updateManoeverMods() {
        ...
        let selectedKampfstil = hardcoded.getSelectedStil(
            this.actor.system.misc?.selected_kampfstil ?? 'ohne',
            this.actor.misc.kampfstile_list,
        )
        let reiterkampf =
        ...
        ;[mod_at, mod_vt, mod_dm, text_at, text_vt, text_dm, trefferzone, schaden, nodmg] =
