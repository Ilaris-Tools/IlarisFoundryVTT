        ...
        */
        ...
        this.item.manoever.forEach((manoever) => {
            if (manoever.inputValue.field == 'CHECKBOX') {
                manoever.inputValue.value =
                    html.find(`#${manoever.id + manoever.inputValue.field}`)[0]?.checked || false
            } else {
                console.log(
                    manoever.inputValue.name,
                    html.find(`#${manoever.id + manoever.inputValue.field}`)[0]?.value,
                )
                manoever.inputValue.value =
                    html.find(`#${manoever.id + manoever.inputValue.field}`)[0]?.value || false
            }
        })
    }
