...
- **[ANNAHME]** Eine cancelable Hook-Konvention (`return false` stoppt die Aktion) folgt dem FoundryVTT-Standard.
...
- **Was**: Neues Modul `scripts/combat/combat-api.js` mit einer öffentlichen Factory-Funktion:
